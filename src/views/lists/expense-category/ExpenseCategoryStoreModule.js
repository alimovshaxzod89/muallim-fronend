  ...
  actions: {
    fetchDatas({ commit }, queryParams) {
      return new Promise((resolve, reject) => {
        axios
          .get('/api/expense-categories', { params: queryParams })
          .then(response => {
    ...
    addRow({ commit }, row) {
      return new Promise((resolve, reject) => {
        axios
          .post('api/expense-categories', row)
          .then(response => {
    ...
    updateRow({ commit, getters }, row) {
      return new Promise((resolve, reject) => {
        axios
          .put(`api/expense-categories/${row.id}`, row)
          .then(response => {
            if (response.data.success) {
    ...
    removeRow({ commit, getters }, id) {
      return new Promise((resolve, reject) => {
        axios.delete(`api/expense-categories/${id}`).then(response => {
          if (response.data.success) {
