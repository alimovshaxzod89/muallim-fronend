...
<div class="container">
  ...
  <div style="margin-bottom: 15px"> 
      <b-form-select v-model="year" :options="yearOptions" style="width: 100px"></b-form-select>
     <b-form-select v-model="month" :options="monthOptions" style="width: 200px"></b-form-select>
  </div>
  ...
  <div class="row d-flex mt-2">
   ...
   <div class="col">
    ...
    <div class="container" style="margin-top: 30px">
      <div class="row">
        <div class="col">
          <b-card no-body style="padding: 30px">
            <b-card-header>
...
export default {
  name: "home",
  components:{
    VueApexCharts, BFormSelect, BCard, BCardTitle, BCardSubTitle, BCardBody, BCardHeader,
